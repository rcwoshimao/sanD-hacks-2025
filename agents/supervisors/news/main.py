...
async def get_capabilities():
  ...
  return {
    ...
    "description": "An AI agent that supervises web scraping and news aggregation operations.",
    "name": "News Supervisor",
    "preferredTransport": "JSONRPC",
    "protocolVersion": "0.3.0",
    "skills": [
      {
        "description": "Orchestrates web scraping, summarization, and ranking of news articles.",
        "examples": [
          "Scrape and summarize articles from https://reddit.com/r/technology",
          "Get trending news from these URLs: https://example.com/news1, https://example.com/news2",
          "Scrape and rank articles by engagement",
        ],
        "id": "scrape_and_summarize",
        "name": "Scrape and Summarize News",
        "tags": ["news", "scraping", "aggregation"],
      }
    ],
